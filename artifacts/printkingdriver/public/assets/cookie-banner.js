    ...
    wrap.innerHTML =
      '<div class="pkd-cookie__inner">' +
        '<div class="pkd-cookie__copy">' +
          ...
          '<p class="pkd-cookie__text">We use a small number of cookies to keep the site secure and to understand how visitors use it. You can accept all cookies, reject non-essential cookies, or read more in our <a href="/privacy">Privacy Policy</a>.</p>' +
        '</div>' +
        '<div class="pkd-cookie__actions">' +
          '<button type="button" class="pkd-cookie__btn pkd-cookie__btn--ghost" data-pkd-consent="essential">Reject non-essential</button>' +
          '<button type="button" class="pkd-cookie__btn pkd-cookie__btn--primary" data-pkd-consent="all">Accept all cookies</button>' +
        '</div>' +
      '</div>';
